function [ results , clusters ] = knn_kmeans( database_orig , k, datarep, defaultNonDetectedValue, newNonDetectedValue , distanceMetric , k2 , randseed, labelk2, folderKMeansBase)
...
fprintf('\nRunning the %s (%d) algorithm with\n',mfilename,k2)
